...
<body>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="post" action="{{ route('login') }}">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="Enter Name, Email or Phone">
                                                @error('login')
    ...
    <script src="{{ asset('backend/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.j') }}s"></script>
