                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Update Gallery Image</h5>
                            </div>
                            <hr>
                            <form class="row g-3" method="post" action="{{ route('update.gallery.setting') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $gallery->id }}">
                                <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Gallery Image</label>
                                ...
                                <div class="col-12">
                                    ...
                                    <img src="{{ asset($gallery->photo) }}" alt="" style="width: 80px; height: 70px">
                                </div>     
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary px-5">Update Image</button>
                                </div>
                            </form>
                        </div>
                    </div>
