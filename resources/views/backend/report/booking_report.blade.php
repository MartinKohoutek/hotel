                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Booking Report</h5>
                            </div>
                            <hr>
                            <form class="row g-3" method="post" action="{{ route('search.by.date') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="start_date" class="form-control" id="inputFirstName">
                                </div>
                                <div class="col-md-6">
                                    <label for="inputAddress" class="form-label">End Date</label>
                                    <input type="date" name="end_date" class="form-control" id="inputFirstName">
                                </div>            
                                <div class="col-12">
