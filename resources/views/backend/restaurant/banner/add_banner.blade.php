        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Restaurant Banner</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Add Restaurant Banner</h5>
                            </div>
                            <hr>
                            <form class="row g-3" method="post" action="{{ route('store.menu.banner') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
                                    ...
                                    <select name="category_id" id="inputState" class="form-select">
                                        ...
                                        @foreach ($categories as $category)
                                            @php
                                                $ban = App\Models\RestaurantBanner::where('category_id', $category->id)->first();
                                            @endphp
                                            @if (!$ban)
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="offer" class="form-control" id="inputFirstName">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="short_description" class="form-control" id="inputFirstName">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-6">
                                    ...
                                    <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="" style="width: 140px; height: 140px;" class="p-1 bg-primary mt-3">
                                </div>
                                <div class="col-6">
                                    <label for="image" class="form-label">Background</label>
                                    <input type="file" name="background" class="form-control" id="image1" />
                                    <label class="form-label"></label>
                                    <img id="showImage1" src="{{ url('upload/no_image.jpg') }}" alt="" style="width: 140px; height: 140px;" class="p-1 bg-primary mt-3">
                                </div>
                                
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary px-5 d-block mt-3">Store Banner</button>
                                </div>
                            </form>
                        </div>
                    </div>
