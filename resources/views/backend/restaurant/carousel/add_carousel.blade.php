        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Carousel Item</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Add Carousel Item</h5>
                            </div>
                            <hr>
                            <form class="row g-3" method="post" action="{{ route('store.menu.carousel') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-6">
                                    <label for="inputAddress" class="form-label">Short Title</label>
                                    <input type="text" name="short_title" class="form-control" id="inputFirstName">
                                </div>
                                <div class="col-md-6">
