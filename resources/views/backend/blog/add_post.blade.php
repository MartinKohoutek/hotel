                        ...
                        <div class="card-body p-5">
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="post_title" class="form-control" id="inputFirstName">
                                </div>
                                <div class="col-12">
                                    <label for="inputAddress" class="form-label">Short Description</label>
                                    <textarea class="form-control" name="short_description" id="inputAddress" rows="3"></textarea>
                                </div>
                                <div class="col-12">
                                    <label for="inputAddress" class="form-label">Long Description</label>
                                    <textarea class="form-control" name="long_description" id="tinymce" rows="3"></textarea>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary px-5">Store Post</button>
                                </div>
                            </form>
                        </div>
                    </div>
