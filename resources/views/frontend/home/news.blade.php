        ...
        <div class="row justify-content-center home">
            <div class="item col-xl-4 col-lg-6">
                <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="300">
                    <figure><img src="{{ asset('frontend/img/blog-1.jpg') }}" alt="" class="img-fluid"><em>11 Dec</em></figure>
                    <div class="wrapper">
            ...
            <div class="item col-xl-4 col-lg-6">
                <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="400">
                    <figure><img src="{{ asset('frontend/img/blog-3.jpg') }}" alt="" class="img-fluid"><em>24 Dec</em></figure>
                    <div class="wrapper">
            ...
            <div class="item col-xl-4 col-lg-6">
                <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="500">
                    <figure><img src="{{ asset('frontend/img/blog-2.jpg') }}" alt="" class="img-fluid"><em>21 Dec</em></figure>
                    <div class="wrapper">
