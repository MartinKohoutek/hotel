            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w5">
                    ...
                    <div class="bee-block bee-block-2 bee-heading">
                        <h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">CheapHotel<br /> </h1>
                    </div>
        ...
        <div class="bee-row bee-row-14">
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-3 bee-col-w3">
                    ...
                    <div class="bee-block bee-block-2 bee-text">
                        <div class="bee-text-content" style="line-height: 150%; font-size: 12px; font-family: inherit; color: #fafafa;">
                            <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">Praha 12, 34567 AB City</span></p>
                            <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">cheaphotel@example.com </span></p>
